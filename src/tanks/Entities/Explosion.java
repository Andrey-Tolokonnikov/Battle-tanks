...
public class Explosion extends Entity{
	...
	private int framesPerLife = 12;
	
	public Explosion(float x, float y, TextureHandler texture) {
		super(EntityTypes.Explosion, x, y);
		this.x = x;
		this.y = y;
		this.sprites = new Sprites(texture.getImgPeace(16*16,8*16, 3*16, 16), 3, 16);
		this.sprite = new Sprite(sprites, 1.5f);
