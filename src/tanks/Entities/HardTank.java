...
public class HardTank extends Entity {
	...
	public enum Direction {
		UP(8 * HardTank.PixelsSize, 3 * HardTank.PixelsSize, 2 * HardTank.PixelsSize, HardTank.PixelsSize),
		DOWN(12 * HardTank.PixelsSize, 3 * HardTank.PixelsSize, 2 * HardTank.PixelsSize, HardTank.PixelsSize),
		LEFT(10 * HardTank.PixelsSize, 3 * HardTank.PixelsSize, 2 * HardTank.PixelsSize, HardTank.PixelsSize),
		RIGHT(14 * HardTank.PixelsSize, 3 * HardTank.PixelsSize, 2 * HardTank.PixelsSize, HardTank.PixelsSize);
